...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.22 2020-07-29 00:44:48 GMT")
...
{	struct __tds__GetServices soap_tmp___tds__GetServices;
	if (soap_endpoint == NULL)
		soap_endpoint = "http://192.168.0.51:8888/onvif/device_service";
	if (soap_action == NULL)
...
{	struct __tev__AddEventBroker soap_tmp___tev__AddEventBroker;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__AddEventBroker(soap, &soap_tmp___tev__AddEventBroker, "-tev:AddEventBroker", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__DeleteEventBroker soap_tmp___tev__DeleteEventBroker;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__DeleteEventBroker(soap, &soap_tmp___tev__DeleteEventBroker, "-tev:DeleteEventBroker", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tev__GetEventBrokers soap_tmp___tev__GetEventBrokers;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___tev__GetEventBrokers(soap, &soap_tmp___tev__GetEventBrokers, "-tev:GetEventBrokers", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __tptz__GetServiceCapabilities soap_tmp___tptz__GetServiceCapabilities;
	if (soap_endpoint == NULL)
		soap_endpoint = "http://192.168.0.51:8888/onvif/PTZ";
	if (soap_action == NULL)
...
{	struct __trt__GetServiceCapabilities soap_tmp___trt__GetServiceCapabilities;
	if (soap_endpoint == NULL)
		soap_endpoint = "http://192.168.0.51:8888/onvif/Media";
	if (soap_action == NULL)

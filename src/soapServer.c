...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.22 2020-07-29 00:44:48 GMT")
...
{	struct __tev__AddEventBroker soap_tmp___tev__AddEventBroker;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put__tev__AddEventBrokerResponse(soap, &tev__AddEventBrokerResponse, "tev:AddEventBrokerResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
{	struct __tev__DeleteEventBroker soap_tmp___tev__DeleteEventBroker;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put__tev__DeleteEventBrokerResponse(soap, &tev__DeleteEventBrokerResponse, "tev:DeleteEventBrokerResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
{	struct __tev__GetEventBrokers soap_tmp___tev__GetEventBrokers;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put__tev__GetEventBrokersResponse(soap, &tev__GetEventBrokersResponse, "tev:GetEventBrokersResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
